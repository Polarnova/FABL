...
:::lemma_ "support-symmetric-fourier-coefficients" (lean := "FABL.fourierCoeff_eq_of_card_eq_of_isSymmetric") (uses := "support-exercise-1.30a, definition-2.8") (tags := "section-5-3, support, fidelity-exact")
...
:::lemma_ "support-exercise-1.8" (lean := "FABL.fourierCoeff_eq_zero_of_odd_of_even_card") (uses := "theorem-1.1, proposition-1.8") (tags := "section-5-3, support, fidelity-exact-used-part")
...
:::lemma_ "support-exercise-5.18" (lean := "FABL.arcsinSeriesCoefficient, FABL.arcsinOddPowerCoefficient, FABL.arcsinOddPowerCoefficient_two_mul_add_one, FABL.exercise5_18a, FABL.exercise5_18_arcsinSeries, FABL.exercise5_18") (tags := "section-5-3, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.20" (lean := "FABL.fourierCoeff_majority_complementary") (uses := "theorem-5.19") (tags := "section-5-3, support, fidelity-exact")
...
:::corollary "corollary-5.20" (lean := "FABL.fourierWeightAtLevel_majority_complementary") (uses := "support-exercise-5.20") (tags := "section-5-3, fidelity-exact")
...
:::lemma_ "support-exercise-5.22" (lean := "FABL.fourierWeightAtLevel_majority_eq_choose_mul, FABL.fourierCoeff_majority_next_odd_eq, FABL.fourierWeightAtLevel_majority_next_odd_eq, FABL.fourierWeightAtLevel_majority_next_odd_lt") (uses := "theorem-5.19") (tags := "section-5-3, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.24" (lean := "FABL.exercise5_24") (tags := "section-5-3, support, fidelity-exact")
...
:::theorem "theorem-5.22" (lean := "FABL.limitingMajorityFourierWeight_pos_of_odd, FABL.fourierWeightAtLevel_majority_two_mul_add_one_eq_limiting_mul, FABL.limitingMajorityFourierWeight_le_fourierWeightAtLevel_majority, FABL.fourierWeightAtLevel_majority_le_limitingMajorityFourierWeight, FABL.majorityFourierWeight_bounds, FABL.fourierWeightAtLevel_majority_odd_tendsto, FABL.fourierWeightAtLevel_majority_odd_strictAnti_and_tendsto") (uses := "theorem-5.19, corollary-5.21, support-limiting-majority-fourier-weights, support-exercise-5.24, support-exercise-2.22") (tags := "section-5-3, fidelity-exact")
...
:::corollary "corollary-5.23" (lean := "FABL.exists_majorityFourierConcentrationCutoff, FABL.corollary5_23") (uses := "support-exercise-5.27") (tags := "section-5-3, fidelity-exact")
