...
:::lemma_ "support-exercise-3.9" (parent := "fabl-chapter-5") (lean := "FABL.abs_fourierCoeff_le_uniformLpNorm_one, FABL.abs_apply_le_fourierOneNorm") (uses := "theorem-1.1, proposition-1.8, definition-3.8") (tags := "section-5-1, support, fidelity-exact")
...
:::lemma_ "support-exercise-1.1g-inner-product-mod-two" (parent := "fabl-chapter-5") (lean := "FABL.f₂CubeBlockEquiv, FABL.joinF₂CubeBlocks, FABL.f₂CubeBlockEquiv_joinF₂CubeBlocks, FABL.joinF₂CubeBlocks_castAdd, FABL.joinF₂CubeBlocks_natAdd, FABL.joinF₂CubeBlocks_addNat, FABL.innerProductModTwoBit, FABL.innerProductModTwo, FABL.innerProductModTwoBoolean, FABL.innerProductModTwoBit_joinF₂CubeBlocks, FABL.f₂DotProduct_joinF₂CubeBlocks, FABL.innerProductModTwo_joinF₂CubeBlocks, FABL.vectorWalshCharacter_joinF₂CubeBlocks, FABL.vectorFourierCoeff_innerProductModTwo_joinF₂CubeBlocks, FABL.abs_vectorFourierCoeff_innerProductModTwo, FABL.innerProductModTwoBoolean_toReal, FABL.abs_fourierCoeff_innerProductModTwoBoolean") (uses := "equation-3.1, theorem-1.1") (tags := "section-5-1, support, fidelity-exact")
...
:::definition "definition-5.4" (parent := "fabl-chapter-5") (lean := "FABL.IsPolynomialThresholdRepresentation, FABL.IsPolynomialThreshold") (uses := "support-exercise-1.10-degree") (tags := "section-5-1, fidelity-exact")
...
:::lemma_ "support-exercise-5.1" (parent := "fabl-chapter-5") (lean := "FABL.exists_integer_linearThresholdRepresentation, FABL.exists_integer_polynomialThresholdRepresentation") (uses := "definition-2.5, definition-5.4, theorem-1.1") (tags := "section-5-1, support, fidelity-exact")
...
:::theorem "theorem-5.1" (parent := "fabl-chapter-5") (lean := "FABL.eq_of_isLinearThreshold_of_fourierCoeff_eq") (uses := "definition-2.5, support-exercise-5.1, plancherel") (tags := "section-5-1, fidelity-exact")
...
:::theorem "theorem-5.2" (parent := "fabl-chapter-5") (lean := "FABL.fourierDegree_affineLinearForm_le_one, FABL.one_half_le_fourierWeightAtMost_one_of_isLinearThreshold") (uses := "definition-1.19, support-exercise-5.5") (tags := "section-5-1, fidelity-exact")
...
:::theorem "conjecture-5.3" (parent := "fabl-chapter-5") (uses := "theorem-5.2, support-exercise-2.22") (tags := "section-5-1, open, conjecture")
...
:::proposition "proposition-5.6" (parent := "fabl-chapter-5") (lean := "FABL.exists_polynomialThreshold_relativeHammingDist_le_three_mul_noiseSensitivity") (uses := "definition-1.29, definition-5.4, proposition-3.3, proposition-3.31") (tags := "section-5-1, fidelity-exact-natural-cutoff")
...
:::definition "definition-5.7" (parent := "fabl-chapter-5") (lean := "FABL.polynomialSparsity") (uses := "definition-5.4, support-exercise-1.10-degree") (tags := "section-5-1, fidelity-exact")
...
:::lemma_ "support-exercise-5.9" (parent := "fabl-chapter-5") (lean := "FABL.eq_of_polynomialThresholdRepresentation_of_fourierCoeff_eq") (uses := "definition-5.4, support-exercise-5.1, plancherel") (tags := "section-5-1, support, fidelity-exact")
...
:::theorem "theorem-5.8" (parent := "fabl-chapter-5") (lean := "FABL.eq_of_isPolynomialThreshold_of_fourierCoeff_eq") (uses := "support-exercise-5.9") (tags := "section-5-1, fidelity-exact")
...
:::theorem "post-theorem-9.22" (parent := "fabl-chapter-5") (tags := "section-5-1, support, deferred, later-chapter-dependency")
...
:::theorem "theorem-5.9" (parent := "fabl-chapter-5") (uses := "definition-1.19, definition-5.4, plancherel, post-theorem-9.22") (tags := "section-5-1, deferred, later-chapter-dependency")
...
:::theorem "theorem-5.10" (parent := "fabl-chapter-5") (lean := "FABL.one_le_sum_abs_fourierCoeff_of_polynomialThresholdRepresentation") (uses := "definition-5.7, support-exercise-3.9, plancherel") (tags := "section-5-1, fidelity-corrected-book-omission")
...
:::theorem "theorem-5.12" (parent := "fabl-chapter-5") (lean := "FABL.exists_sparsePolynomial_uniformApproximation") (uses := "theorem-1.1, definition-3.8, definition-5.7, support-exercise-3.9") (tags := "section-5-1, fidelity-explicit-positive-arity")
...
:::corollary "corollary-5.13" (parent := "fabl-chapter-5") (lean := "FABL.exists_polynomialThresholdRepresentation_sparsity_le_ceil, FABL.exists_parityMajorityRepresentation") (uses := "definition-5.4, definition-5.7, theorem-5.12") (tags := "section-5-1, fidelity-explicit-positive-arity")
