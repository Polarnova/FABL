...
:::lemma_ "support-exercise-5.3" (lean := "FABL.influence_le_of_abs_linearThresholdWeight_le") (uses := "definition-2.5, definition-2.13") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.6" (lean := "FABL.exists_one_div_sqrt_two_mul_dimension_le_influence_of_balanced_linearThreshold") (uses := "parseval, theorem-5.2, support-exercise-2.5-unate, support-exercise-2.6-ltf-unate") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.7" (lean := "FABL.signPairFamilyLeft, FABL.signPairFamilyRight, FABL.pmfExpectation_apply_left_mul_right_eq_fourierCoeff_mul_correlation, FABL.hasEqualSingletonFourierCoefficients_majority, FABL.fourierCoeff_singleton_le_majority_of_equal") (uses := "definition-2.41, theorem-2.33") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.8" (lean := "FABL.fourierInfinityNorm, FABL.randomBooleanFourierThreshold, FABL.measure_randomBooleanFunction_fourierInfinityNorm_gt_le") (uses := "theorem-1.1") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.10" (lean := "FABL.not_isPolynomialThreshold_parityFunction_univ_pred, FABL.isPolynomialThreshold_pred_of_ne_parityFunction_univ") (uses := "theorem-1.1, definition-5.4, theorem-5.10") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.25" (lean := "FABL.fourierWeightAtLevel_majority_oddArity_tendsto") (uses := "theorem-2.45, theorem-2.49, support-limiting-majority-fourier-weights") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.35" (lean := "FABL.exists_signedDictator_relativeHammingDist_le_of_isBalanced_totalInfluence_le") (uses := "parseval, support-exercise-2.5-unate, proposition-3.2") (tags := "section-5-6, support, fidelity-exact")
...
:::lemma_ "support-exercise-5.39" (lean := "FABL.fourierWeightAbove_pred_le_four_div_sqrt_of_isLinearThreshold, FABL.deriv_noiseSensitivityCurve_le_sqrt_three_halves_div_sqrt_of_isLinearThreshold") (uses := "theorem-2.49, fact-2.53, peres-theorem") (tags := "section-5-6, support, fidelity-exact-explicit-universal-constant")
...
:::lemma_ "support-exercise-5.42" (lean := "FABL.smallSetCenterOfMass, FABL.smallSetCenterOfMass_apply, FABL.sum_sq_smallSetCenterOfMass, FABL.exists_smallSetCenterOfMass_sqNorm_constant, FABL.exists_smallSetCenterOfMass_norm_constant") (uses := "theorem-1.1, level-1-inequality") (tags := "section-5-6, support, fidelity-exact")
...
:::theorem "conjecture-exercise-5.45b" (uses := "definition-2.5, definition-5.4") (tags := "section-5-6, open, conjecture")
...
:::lemma_ "notes-5.6-provenance" (tags := "section-5-6, nondependency, bibliographic")
