...
:::definition "definition-2.27" (parent := "fabl-chapter-2") (lean := "FABL.totalInfluence") (uses := "definition-2.17") (tags := "section-2-3, fidelity-exact")
*Definition 2.27.* For every $`f:\{-1,1\}^n\to\mathbb R`, the total influence
of $`f` is
$$`\mathbf I[f]=\sum_{i=1}^{n}\operatorname{Inf}_i[f].`
:::

:::proposition "proposition-2.28" (parent := "fabl-chapter-2") (lean := "FABL.sensitivity, FABL.totalInfluence_toReal_eq_expect_sensitivity") (uses := "definition-2.12, definition-2.13, definition-2.27") (tags := "section-2-3, fidelity-exact")
...
:::proposition "proposition-2.31" (parent := "fabl-chapter-2") (lean := "FABL.totalInfluence_eq_sum_fourierCoeff_singleton_of_monotone") (uses := "definition-2.27, proposition-2.21") (tags := "section-2-3, fidelity-exact")
...
:::proposition "proposition-2.32" (parent := "fabl-chapter-2") (lean := "FABL.agreeingVoteCount, FABL.expect_agreeingVoteCount") (uses := "definition-2.11, proposition-1.8") (tags := "section-2-3, fidelity-exact")
...
:::lemma_ "equation-2.3" (parent := "fabl-chapter-2") (lean := "FABL.sum_fourierCoeff_singleton_eq_expect_mul_sum_signValue") (uses := "proposition-1.8") (tags := "section-2-3, support, fidelity-exact")
...
:::lemma_ "equation-2.4" (parent := "fabl-chapter-2") (lean := "FABL.totalInfluence_eq_expect_sum_sq_discreteDerivative") (uses := "definition-2.17, definition-2.27") (tags := "section-2-3, support, fidelity-exact")
...
:::definition "definition-2.34" (parent := "fabl-chapter-2") (lean := "FABL.discreteGradient, FABL.norm_discreteGradient_toReal_sq_eq_sensitivity") (uses := "definition-2.16, proposition-2.28") (tags := "section-2-3, fidelity-exact")
...
:::proposition "proposition-2.35" (parent := "fabl-chapter-2") (lean := "FABL.totalInfluence_eq_expect_norm_discreteGradient_sq") (uses := "equation-2.4, definition-2.34") (tags := "section-2-3, fidelity-exact")
...
:::definition "definition-2.36" (parent := "fabl-chapter-2") (lean := "FABL.laplacian") (uses := "definition-2.25") (tags := "section-2-3, fidelity-exact")
...
:::lemma_ "support-exercise-2.17" (parent := "fabl-chapter-2") (lean := "FABL.laplacian_eq_sum_sub_flip_div_two, FABL.laplacian_toReal_eq_mul_sensitivity, FABL.laplacian_eq_fourier_sum, FABL.uniformInner_laplacian_eq_totalInfluence") (uses := "theorem-1.1, proposition-2.26, definition-2.27, definition-2.36") (tags := "section-2-3, support, fidelity-exact")
...
:::proposition "proposition-2.37" (parent := "fabl-chapter-2") (lean := "FABL.laplacian_eq_card_mul_sub_expect_flip") (uses := "support-exercise-2.17") (tags := "section-2-3, fidelity-exact")
...
:::theorem "theorem-2.38" (parent := "fabl-chapter-2") (lean := "FABL.totalInfluence_eq_sum_card_mul_sq_fourierCoeff, FABL.totalInfluence_eq_sum_level_mul_fourierWeight, FABL.totalInfluence_toReal_eq_spectralSample_expectedCard") (uses := "definition-1.19, definition-2.27, theorem-2.20") (tags := "section-2-3, fidelity-exact")
...
:::lemma_ "support-exercise-1.19ab" (parent := "fabl-chapter-2") (lean := "FABL.eq_dictator_or_neg_dictator_of_fourierWeightAtLevel_one_eq_one, FABL.isKJunta_one_of_fourierWeightAtMost_one_eq_one") (uses := "definition-1.19, definition-2.16, equation-2.1") (tags := "section-2-3, support, fidelity-exact")
...
:::theorem "theorem-2.39" (parent := "fabl-chapter-2") (lean := "FABL.positiveProbability, FABL.negativeProbability, FABL.minorityProbability, FABL.two_mul_minorityProbability_mul_logb_inv_le_totalInfluence") (uses := "notation-1.4, definition-2.27") (tags := "section-2-3, fidelity-exact-log-base-two")
