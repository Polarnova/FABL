...
:::definition "definition-2.12" (parent := "fabl-chapter-2") (lean := "FABL.setCoordinate, FABL.flipCoordinate, FABL.IsPivotal, FABL.isPivotal_iff_setCoordinate_ne") (tags := "section-2-2, fidelity-exact")
...
:::definition "definition-2.13" (parent := "fabl-chapter-2") (lean := "FABL.booleanInfluence") (uses := "definition-2.12, notation-1.4") (tags := "section-2-2, fidelity-exact")
...
:::lemma_ "fact-2.14" (parent := "fabl-chapter-2") (lean := "FABL.DimensionEdge, FABL.IsBoundaryDimensionEdge, FABL.dimensionEdgeBoundaryFraction, FABL.booleanInfluence_eq_dimensionEdgeBoundaryFraction") (uses := "definition-2.12, definition-2.13") (tags := "section-2-2, fidelity-exact")
...
:::definition "definition-2.16" (parent := "fabl-chapter-2") (lean := "FABL.discreteDerivative, FABL.discreteDerivative_apply, FABL.discreteDerivative_add, FABL.discreteDerivative_setCoordinate") (tags := "section-2-2, fidelity-exact")
...
:::lemma_ "equation-2.1" (parent := "fabl-chapter-2") (lean := "FABL.pivotalIndicator, FABL.sq_discreteDerivative_toReal_eq_pivotalIndicator") (uses := "definition-2.12, definition-2.16") (tags := "section-2-2, support, fidelity-exact")
...
:::definition "definition-2.17" (parent := "fabl-chapter-2") (lean := "FABL.influence, FABL.booleanInfluence_eq_influence_toReal") (uses := "definition-1.3, definition-2.16, equation-2.1") (tags := "section-2-2, fidelity-exact")
...
:::definition "definition-2.18" (parent := "fabl-chapter-2") (lean := "FABL.IsRelevant, FABL.isRelevant_iff_exists_setCoordinate_ne") (uses := "definition-2.17") (tags := "section-2-2, fidelity-exact")
...
:::proposition "proposition-2.19" (parent := "fabl-chapter-2") (lean := "FABL.discreteDerivative_eq_fourier_sum") (uses := "definition-2.16, theorem-1.1") (tags := "section-2-2, fidelity-exact")
...
:::theorem "theorem-2.20" (parent := "fabl-chapter-2") (lean := "FABL.influence_eq_sum_sq_fourierCoeff") (uses := "definition-2.17, proposition-2.19, parseval") (tags := "section-2-2, fidelity-exact")
*Theorem 2.20.* For every $`f:\{-1,1\}^n\to\mathbb R` and $`i\in[n]`,
$$`\operatorname{Inf}_i[f]
=\sum_{\substack{S\subseteq[n]\\i\in S}}\widehat f(S)^2.`
:::

:::proposition "proposition-2.21" (parent := "fabl-chapter-2") (lean := "FABL.influence_eq_fourierCoeff_singleton_of_monotone") (uses := "definition-2.8, definition-2.17, equation-2.1, proposition-2.19, fact-1.12") (tags := "section-2-2, fidelity-exact")
...
:::proposition "proposition-2.22" (parent := "fabl-chapter-2") (lean := "FABL.influence_le_one_div_sqrt_of_transitiveSymmetric_monotone") (uses := "definition-2.10, proposition-2.21, support-exercise-1.30a, parseval") (tags := "section-2-2, fidelity-exact")
*Proposition 2.22.* If
$`f:\{-1,1\}^n\to\{-1,1\}` is transitive-symmetric and monotone, then
$`\operatorname{Inf}_i[f]\le\frac1{\sqrt n}` for every $`i\in[n]`.
:::

:::definition "definition-2.23" (parent := "fabl-chapter-2") (lean := "FABL.coordinateExpectation") (uses := "notation-1.4") (tags := "section-2-2, fidelity-exact")
...
:::proposition "proposition-2.24" (parent := "fabl-chapter-2") (lean := "FABL.coordinateExpectation_apply, FABL.coordinateExpectation_eq_fourier_sum, FABL.eq_signValue_mul_discreteDerivative_add_coordinateExpectation, FABL.coordinateExpectation_setCoordinate") (uses := "definition-2.16, definition-2.23, theorem-1.1") (tags := "section-2-2, fidelity-exact")
...
:::definition "definition-2.25" (parent := "fabl-chapter-2") (lean := "FABL.coordinateLaplacian") (uses := "definition-2.23") (tags := "section-2-2, fidelity-exact")
