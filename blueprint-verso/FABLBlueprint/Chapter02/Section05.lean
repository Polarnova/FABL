...
:::lemma_ "support-exercise-1.1i" (lean := "FABL.IsNAE3, FABL.Ranking3, FABL.rankingPreference, FABL.rankingPreference_isNAE3, FABL.exists_rankingPreference_eq_iff_isNAE3") (tags := "section-2-5, support, fidelity-exact")
...
:::definition "support-three-candidate-condorcet-model" (lean := "FABL.PairwiseContest, FABL.RankingProfile, FABL.pairwiseVotes, FABL.societalOutcome, FABL.SatisfiesIIA, FABL.societalOutcome_satisfiesIIA") (uses := "support-exercise-1.1i") (tags := "section-2-5, support, fidelity-exact")
...
:::definition "definition-2.55" (lean := "FABL.IsCondorcetWinner, FABL.HasCondorcetWinner, FABL.HasSocietalCondorcetWinner, FABL.hasCondorcetWinner_iff_isNAE3") (uses := "support-three-candidate-condorcet-model") (tags := "section-2-5, fidelity-exact")
...
:::theorem "arrows-theorem" (lean := "FABL.arrowsTheorem") (uses := "definition-2.3, definition-2.8, definition-2.55, theorem-2.49, theorem-2.56, support-exercise-1.19ab") (tags := "section-2-5, fidelity-exact")
...
:::theorem "theorem-2.56" (lean := "FABL.condorcetWinnerProbability, FABL.condorcetWinnerProbability_eq_noiseStability") (uses := "definition-2.11, definition-2.42, definition-2.55, support-kalai-condorcet-calculation") (tags := "section-2-5, fidelity-exact")
...
:::theorem "guilbauds-formula" (lean := "FABL.tendsto_condorcetWinnerProbability_majority_odd") (uses := "definition-2.1, theorem-2.45, theorem-2.56") (tags := "section-2-5, fidelity-exact")
...
:::proposition "proposition-2.58" (lean := "FABL.exists_levelOneWeight_upperError_isLittleO, FABL.fourierWeightAtLevel_one_eventually_le_two_div_pi_add") (uses := "definition-1.19, theorem-2.33, support-exercise-2.24") (tags := "section-2-5, fidelity-exact")
...
:::corollary "corollary-2.59" (lean := "FABL.condorcetWinnerProbability_le") (uses := "definition-1.19, theorem-2.49, theorem-2.56, parseval") (tags := "section-2-5, fidelity-exact")
...
:::corollary "corollary-2.60" (lean := "FABL.exists_signedDictator_relativeHammingDist_le_of_condorcetWinnerProbability_eq_one_sub, FABL.relativeHammingDist_signedDictator_family_isBigO_of_condorcetWinnerProbability_eq_one_sub") (uses := "definition-1.10, corollary-2.59, fkn-theorem") (tags := "section-2-5, fidelity-exact")
...
:::theorem "fkn-theorem" (lean := "FABL.signedDictator, FABL.fkn, FABL.fkn_family_isBigO") (uses := "definition-1.10, definition-1.19, definition-2.3") (tags := "section-2-5, fidelity-exact")
