...
:::definition "definition-2.40" (parent := "fabl-chapter-2") (lean := "FABL.correlationKeepProbability, FABL.coordinateNoisePMF, FABL.nonnegativeCorrelationProbability, FABL.coordinateResamplingNoisePMF, FABL.coordinateResamplingNoisePMF_eq_coordinateNoisePMF, FABL.noiseKernel, FABL.resamplingNoiseKernel, FABL.resamplingNoiseKernel_eq_noiseKernel") (uses := "notation-1.4") (tags := "section-2-4, fidelity-exact")
...
:::definition "definition-2.41" (parent := "fabl-chapter-2") (lean := "FABL.correlatedPairPMF, FABL.correlatedPairPMF_map_swap, FABL.correlatedPairPMF_expect_signValue_fst, FABL.correlatedPairPMF_expect_signValue_snd, FABL.correlatedPairPMF_expect_signValue_mul") (uses := "definition-2.40, notation-1.4") (tags := "section-2-4, fidelity-exact")
...
:::definition "definition-2.42" (parent := "fabl-chapter-2") (lean := "FABL.noiseStability, FABL.correlatedAgreementProbability, FABL.correlatedDisagreementProbability, FABL.noiseStability_toReal_eq_agreement_sub_disagreement, FABL.noiseStability_toReal_eq_two_mul_agreement_sub_one") (uses := "definition-2.41") (tags := "section-2-4, fidelity-exact")
...
:::definition "definition-2.43" (parent := "fabl-chapter-2") (lean := "FABL.noiseSensitivity, FABL.noiseSensitivity_eq_half_sub_half_noiseStability") (uses := "definition-2.41, definition-2.42") (tags := "section-2-4, fidelity-exact")
...
:::lemma_ "example-2.44" (parent := "fabl-chapter-2") (lean := "FABL.noiseStability_const_one, FABL.noiseStability_const_neg_one, FABL.noiseStability_dictator, FABL.noiseSensitivity_dictator, FABL.noiseStability_parityFunction") (uses := "definition-1.2, definition-2.3, definition-2.42, definition-2.43") (tags := "section-2-4, fidelity-exact")
...
:::definition "definition-2.46" (parent := "fabl-chapter-2") (lean := "FABL.noiseOperator, FABL.noiseOperator_apply_eq_pmfExpectation") (uses := "definition-2.40") (tags := "section-2-4, fidelity-exact")
...
:::proposition "proposition-2.47" (parent := "fabl-chapter-2") (lean := "FABL.noiseOperator_monomial_apply, FABL.noiseOperator_fourier_expansion, FABL.noiseOperator_eq_sum_degreePart") (uses := "definition-2.46, theorem-1.1, definition-1.19") (tags := "section-2-4, fidelity-exact")
...
:::lemma_ "fact-2.48" (parent := "fabl-chapter-2") (lean := "FABL.noiseStability_eq_uniformInner_noiseOperator") (uses := "definition-2.41, definition-2.42, definition-2.46") (tags := "section-2-4, fidelity-exact")
*Fact 2.48.* For every $`f:\{-1,1\}^n\to\mathbb R` and
$`\rho\in[-1,1]`, one has
$`\operatorname{Stab}_\rho[f]=\langle f,T_\rho f\rangle`.
:::

:::theorem "theorem-2.49" (parent := "fabl-chapter-2") (lean := "FABL.noiseStability_eq_sum_rho_pow_mul_sq_fourierCoeff, FABL.noiseStability_eq_sum_level_rho_pow_mul_fourierWeight, FABL.noiseStability_toReal_eq_spectralSample_moment, FABL.noiseSensitivity_eq_sum_level") (uses := "definition-1.18, definition-1.19, definition-2.43, proposition-2.47, fact-2.48, plancherel") (tags := "section-2-4, fidelity-exact")
...
:::lemma_ "support-exercise-2.42" (parent := "fabl-chapter-2") (lean := "FABL.noiseSensitivity_le_delta_mul_totalInfluence") (uses := "definition-2.27, theorem-2.49") (tags := "section-2-4, support, fidelity-exact")
...
:::proposition "proposition-2.50" (parent := "fabl-chapter-2") (lean := "FABL.noiseStability_le_rho_of_balanced, FABL.noiseStability_eq_rho_iff_signed_dictator") (uses := "definition-1.11, theorem-2.49, support-exercise-1.19ab, parseval") (tags := "section-2-4, fidelity-exact")
...
:::proposition "proposition-2.51" (parent := "fabl-chapter-2") (lean := "FABL.deriv_stabilityCurve_zero, FABL.deriv_stabilityCurve_one, FABL.deriv_noiseSensitivityCurve_zero, FABL.monotoneOn_noiseSensitivityCurve") (uses := "definition-1.19, definition-2.43, theorem-2.38, theorem-2.49") (tags := "section-2-4, fidelity-exact")
...
:::definition "definition-2.52" (parent := "fabl-chapter-2") (lean := "FABL.stableInfluence, FABL.stableInfluence_eq_noiseStability_discreteDerivative, FABL.totalStableInfluence") (uses := "definition-2.16, definition-2.42, theorem-2.20") (tags := "section-2-4, fidelity-exact")
...
:::lemma_ "support-exercise-2.40" (parent := "fabl-chapter-2") (lean := "FABL.deriv_stabilityCurve_eq_totalStableInfluence, FABL.totalStableInfluence_eq_sum_card_mul_rho_pow_mul_sq_fourierCoeff") (uses := "definition-2.52, theorem-2.38, theorem-2.49") (tags := "section-2-4, support, fidelity-exact")
...
:::lemma_ "fact-2.53" (parent := "fabl-chapter-2") (lean := "FABL.totalStableInfluence_eq_sum_level") (uses := "definition-2.52, support-exercise-2.40") (tags := "section-2-4, fidelity-exact")
...
:::lemma_ "support-exercise-2.45" (parent := "fabl-chapter-2") (lean := "FABL.card_mul_one_sub_pow_le_inv") (tags := "section-2-4, support, fidelity-exact")
...
:::proposition "proposition-2.54" (parent := "fabl-chapter-2") (lean := "FABL.card_stableInfluence_ge_le") (uses := "proposition-1.13, definition-2.52, fact-2.53, support-exercise-2.45") (tags := "section-2-4, fidelity-exact-denominator-delta-epsilon")
