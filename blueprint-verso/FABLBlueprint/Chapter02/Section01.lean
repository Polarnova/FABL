...
:::definition "definition-2.1" (lean := "FABL.thresholdSign, FABL.majority, FABL.IsMajorityFunction, FABL.majority_isMajorityFunction") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.2" (lean := "FABL.andFunction, FABL.orFunction") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.3" (lean := "FABL.dictator, FABL.dictator_toReal_eq_monomial_singleton") (uses := "support-sign-monomial") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.4" (lean := "FABL.IsKJunta, FABL.isKJunta_iff_exists_factorization") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.5" (lean := "FABL.IsLinearThreshold") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.6" (lean := "FABL.recursiveMajority, FABL.recursiveMajority_one, FABL.recursiveMajority_succ") (uses := "definition-2.1") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.7" (lean := "FABL.inputBlock, FABL.tribes") (uses := "definition-2.2") (tags := "section-2-1, fidelity-exact")
...
:::lemma_ "support-exercise-1.30a" (lean := "FABL.permuteInput, FABL.permuteFinset, FABL.fourierCoeff_comp_permuteInput") (uses := "proposition-1.8") (tags := "section-2-1, support, fidelity-exact")
...
:::definition "definition-2.8" (lean := "Monotone, Function.Odd, FABL.IsUnanimous, FABL.IsSymmetric, FABL.isSymmetric_iff_eq_of_positiveCoordinateCount_eq") (uses := "support-exercise-1.30a") (tags := "section-2-1, fidelity-exact")
...
:::lemma_ "support-exercise-2.3" (lean := "FABL.IsEqualWeightThreshold, FABL.symmetric_and_monotone_iff_isEqualWeightThreshold, FABL.may_theorem") (uses := "definition-2.1, definition-2.5, definition-2.8") (tags := "section-2-1, support, fidelity-exact")
...
:::lemma_ "example-2.9" (lean := "FABL.example2_9") (uses := "definition-2.1, definition-2.2, definition-2.3, definition-2.6, definition-2.7, definition-2.8, support-exercise-2.3") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.10" (lean := "FABL.IsTransitiveSymmetric") (uses := "support-exercise-1.30a") (tags := "section-2-1, fidelity-exact")
...
:::definition "definition-2.11" (lean := "FABL.impartialCulture") (uses := "notation-1.4") (tags := "section-2-1, fidelity-exact")
