...
:::definition "definition-3.1" (parent := "fabl-chapter-3") (lean := "FABL.fourierWeightAboveReal, FABL.IsFourierSpectrumConcentratedUpTo, FABL.fourierWeightAboveReal_natCast, FABL.spectralSample_tailMass_eq_fourierWeightAboveReal") (uses := "definition-1.18, definition-1.19") (tags := "section-3-1, fidelity-exact-real-cutoff")
...
:::proposition "proposition-3.2" (parent := "fabl-chapter-3") (lean := "FABL.isFourierSpectrumConcentratedUpTo_totalInfluence_div") (uses := "definition-3.1, theorem-2.38") (tags := "section-3-1, fidelity-exact")
...
:::lemma_ "support-noise-tail-bound" (parent := "fabl-chapter-3") (lean := "FABL.one_sub_two_mul_pow_le_exp_neg_two, FABL.one_sub_one_sub_two_mul_pow_nonneg, FABL.monotone_one_sub_one_sub_two_mul_pow, FABL.two_div_one_sub_exp_neg_two_le_three, FABL.two_mul_noiseSensitivity_eq_sum_fourier, FABL.noiseSensitivity_nonneg") (uses := "theorem-2.49") (tags := "section-3-1, support, fidelity-exact")
...
:::proposition "proposition-3.3" (parent := "fabl-chapter-3") (lean := "FABL.isFourierSpectrumConcentratedUpTo_noiseSensitivity, FABL.two_div_one_sub_exp_neg_two_mul_noiseSensitivity_le_three") (uses := "definition-3.1, support-noise-tail-bound, theorem-2.49") (tags := "section-3-1, fidelity-exact")
...
:::lemma_ "lemma-3.5" (parent := "fabl-chapter-3") (lean := "FABL.inv_two_pow_le_uniformProbability_ne_zero_of_fourierDegree_le") (uses := "support-exercise-1.10-degree, support-exercise-3.4") (tags := "section-3-1, fidelity-exact")
...
:::lemma_ "support-degree-discrete-derivative" (parent := "fabl-chapter-3") (lean := "FABL.fourierDegree_discreteDerivative_le_pred, FABL.booleanInfluence_eq_uniformProbability_discreteDerivative_ne_zero") (uses := "proposition-2.19, support-exercise-1.10-degree") (tags := "section-3-1, support, fidelity-exact")
...
:::proposition "proposition-3.6" (parent := "fabl-chapter-3") (lean := "FABL.booleanInfluence_eq_zero_of_fourierDegree_le_zero, FABL.booleanInfluence_eq_zero_or_two_mul_inv_two_pow_le") (uses := "definition-2.17, equation-2.1, lemma-3.5, support-degree-discrete-derivative") (tags := "section-3-1, fidelity-exact")
...
:::lemma_ "fact-3.7" (parent := "fabl-chapter-3") (lean := "FABL.totalInfluence_toReal_le_fourierDegree") (uses := "parseval, support-exercise-1.10-degree, theorem-2.38") (tags := "section-3-1, fidelity-exact")
*Fact 3.7.* Every $`f:\{-1,1\}^n\to\{-1,1\}` satisfies
$`\mathbf I[f]\le\deg(f)`.
:::

:::lemma_ "support-relevant-coordinate-count" (parent := "fabl-chapter-3") (lean := "FABL.isRelevant_of_fourierCoeff_ne_zero, FABL.relevantCoordinates, FABL.mem_relevantCoordinates, FABL.dependsOn_relevantCoordinates, FABL.sum_influence_relevantCoordinates_eq_totalInfluence, FABL.mul_card_relevantCoordinates_le_totalInfluence, FABL.isKJunta_of_card_relevantCoordinates_le, FABL.dependsOn_toReal_iff, FABL.isKJunta_toReal_iff, FABL.isKJunta_of_card_relevantCoordinates_toReal_le") (uses := "definition-2.4, definition-2.18, definition-2.27") (tags := "section-3-1, support, fidelity-exact")
