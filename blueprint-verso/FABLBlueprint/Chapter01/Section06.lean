...
:::definition "definition-1.28" (parent := "fabl-chapter-1") (lean := "FABL.IsF₂Linear, FABL.f₂DotProduct, FABL.isF₂Linear_iff_exists_dotProduct, FABL.isF₂Linear_iff_exists_coordinateSum") (tags := "section-1-6, fidelity-exact")
...
:::definition "definition-1.29" (parent := "fabl-chapter-1") (lean := "FABL.IsClose, FABL.IsFar, FABL.distanceToProperty, FABL.IsCloseToProperty, FABL.exists_relativeHammingDist_eq_distanceToProperty, FABL.isCloseToProperty_iff_distanceToProperty_le") (uses := "definition-1.10") (tags := "section-1-6, fidelity-conservative-generalization-of-common-codomain")
...
:::definition "blr-test" (parent := "fabl-chapter-1") (lean := "FABL.blrAccepts, FABL.blrAcceptanceProbability") (uses := "notation-1.4") (tags := "section-1-6, fidelity-exact")
...
:::lemma_ "support-blr-cubic-identity" (parent := "fabl-chapter-1") (lean := "FABL.signEncode, FABL.realSignEncodedFunction, FABL.binaryParitySign, FABL.two_mul_blrAcceptanceProbability_sub_one_eq_sum_cube_fourierCoeff") (uses := "blr-test, plancherel, theorem-1.27") (tags := "section-1-6, support")
...
:::theorem "theorem-1.30" (parent := "fabl-chapter-1") (lean := "FABL.close_to_linear_of_blrAcceptanceProbability_eq") (uses := "blr-test, definition-1.29, theorem-1.27, parseval, plancherel, proposition-1.9, definition-1.28, support-blr-cubic-identity") (tags := "section-1-6, fidelity-exact")
...
:::proposition "proposition-1.31" (parent := "fabl-chapter-1") (lean := "FABL.localCorrection, FABL.localCorrection_successProbability") (uses := "definition-1.29, definition-1.2") (tags := "section-1-6, fidelity-exact-pointwise-quantifier-order")
