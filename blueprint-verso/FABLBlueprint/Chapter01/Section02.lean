...
:::lemma_ "support-indicator-interpolation" (parent := "fabl-chapter-1") (lean := "FABL.indicatorPolynomial, FABL.indicatorPolynomial_eq_ite, FABL.sum_indicatorPolynomial") (tags := "section-1-2, support")
...
:::definition "support-sign-monomial" (parent := "fabl-chapter-1") (lean := "FABL.monomial, FABL.multilinearPolynomial, FABL.fourierCoeff") (tags := "section-1-2, support")
...
:::theorem "theorem-1.1" (parent := "fabl-chapter-1") (lean := "FABL.fourier_expansion_unique, FABL.fourier_expansion") (uses := "support-indicator-interpolation") (tags := "section-1-2, fidelity-exact-up-to-squarefree-coefficient-representation")
...
:::definition "support-exercise-1.10-degree" (parent := "fabl-chapter-1") (lean := "FABL.fourierSupport, FABL.fourierDegree, FABL.mem_fourierSupport, FABL.fourierDegree_le_iff, FABL.fourierDegree_le_dimension") (uses := "theorem-1.1") (tags := "section-1-2, support, fidelity-exact-with-explicit-zero-function-convention")
...
:::definition "definition-1.2" (parent := "fabl-chapter-1") (lean := "FABL.binarySign, FABL.coordinateSum, FABL.χ, FABL.χ_add") (tags := "section-1-2, fidelity-exact")
...
:::lemma_ "support-binary-fourier-expansion" (parent := "fabl-chapter-1") (lean := "FABL.binaryFourierCoeff, FABL.binary_fourier_expansion") (uses := "definition-1.2, theorem-1.5") (tags := "section-1-2, support")
