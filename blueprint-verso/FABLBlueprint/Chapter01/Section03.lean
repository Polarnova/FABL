...
:::definition "definition-1.3" (parent := "fabl-chapter-1") (lean := "FABL.uniformInner, FABL.uniformLpNorm, FABL.uniformLpNorm_two_eq_sqrt_uniformInner") (tags := "section-1-3, fidelity-exact-with-lp-definition-represented-by-Real-rpow")
...
:::definition "notation-1.4" (parent := "fabl-chapter-1") (lean := "FABL.uniformPMF, FABL.integral_uniformPMF_eq_expect") (tags := "section-1-3, fidelity-exact")
...
:::theorem "theorem-1.5" (parent := "fabl-chapter-1") (lean := "FABL.binaryWalshBasis, FABL.walshBasis, FABL.parity_orthonormal_basis") (uses := "fact-1.6, fact-1.7") (tags := "section-1-3, fidelity-exact-with-explicit-sign-domain")
...
:::lemma_ "fact-1.6" (parent := "fabl-chapter-1") (lean := "FABL.monomial_mul_monomial") (uses := "support-sign-monomial") (tags := "section-1-3, fidelity-exact")
...
:::lemma_ "fact-1.7" (parent := "fabl-chapter-1") (lean := "FABL.expect_monomial") (uses := "notation-1.4") (tags := "section-1-3, fidelity-exact")
